...
int menuOpciones()
{
    ...
    printf("2) Mostrar el tamaño de la LinkedList (ll_len).\n");
    printf("3) Agregar elementos a la LinkedList (ll_add).\n");
    printf("4) Mostrar elementos de la LinkedList (ll_get).\n");
    printf("5) Setear a valores iniciales todos los elementos de la LinkedList (ll_set).\n");
    printf("6) Eliminar el anteultimo elemento de la LinkedList (ll_remove).\n");
